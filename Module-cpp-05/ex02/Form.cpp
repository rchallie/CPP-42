 ...
 * @param target the target where the "Form" can be execute.
 */
...
/**
 * @brief Get the target of the "Form".
 * 
 * @return the target of the "Form".
 */
...
/**
 * @brief Execute the action of the "Form"
 * 
 ...
 * execute the "Form", an string will be throwed.
 * 
 * @param executor the "Bureaucrat" that will execute the form.
 */
void				Form::execute(Bureaucrat const & executor) const
{
	if (!this->_signed)
		throw std::string("the form is not signed.");
	else if (executor.getGrade() > this->_requiered_exec_grade)
